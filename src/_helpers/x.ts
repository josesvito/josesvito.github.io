...
var ROUND_CONSTANTS:Array<number> = [];
...
function hmac(key: any, data: any)
{
	if (key.length > 64)
		key = sha256(key);
...
function sign(inputKey: any, inputData:any)
{
...
function hex(bin: any)
{
	return bin.reduce((acc: any, val: any) =>
